...
ll = legend({'Kernel ambiguity $(\\\epsilon = 0)$','Kernel ambiguity ($\\\epsilon = 0.01$)',...
                'Kernel ambiguity ($\\\epsilon$ = 0.05)','Moment ambiguity ($b = 0.1, c = 1.5$, see [23])'},...
                    'Interpreter','latex','FontSize',14,'Orientation','vertical','Position',[0.58,0.20,0.1,0.1]);
set(ll,'color','none');
...
path_to = '/Users/licioromao/Library/CloudStorage/GoogleDrive-licio.romao@gmail.com/PhD-postdoc/Postdoc/Oxford-CS/Papers/Ashish_collaboration/CDC-paper/Extended-CDC-version/';

kernel_versus_moment = gcf;
temp = strcat(path_to,'kernel-versus-moment-new.pdf');
